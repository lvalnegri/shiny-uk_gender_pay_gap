...
###############################################
# If loading packages cgeates problems with "MAX DLLs reached, set <R_MAX_NUM_DLLS> to more than 100 to let R load all packages and their dependencies
# In Ubuntu run in terminal: export R_MAX_NUM_DLLS=200
...
pkg <- c(
    ...
    # DATA WRANGLING
    'data.table', 'htmltools', 'plyr', 'RMySQL', 'scales',
    # DATA VIZ
